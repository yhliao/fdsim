...
Vds = 0.05
tinsf=0.5e-9
Lg_array = [20e-9,16e-9]#;%m
Ec = 1.4*1e8#2.5e7 #0.162742753246 *1e6/1e-2 #MV/cm to V/m
Pr = 15*1e-6*1e4#22.3298216479 *1e-6/1e-4  #u
tfe = 3e-9
...
print (tfe_array)
print (dibl)
pylab.plot(tfe_array[:-1], dibl[:-1],'o-',markersize=10)
pylab.plot(tfe_array[-1], dibl[-1],'s-',markersize=10)

axes = pylab.gca()
axes.set_xlim([-1e-9,6e-9])
